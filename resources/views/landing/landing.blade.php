...
<html>
   <head>
      ...
      <!-- fevicon -->
      <link rel="icon" href="images/fevicon.png" type="{{ asset('landing/gif') }}" />
      <!-- font css -->
   ...
   <body>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div id="banner_slider" class="carousel slide" data-ride="carousel">
                        ...
                        <a class="carousel-control-prev" href="{{ asset('landing/#banner_slider') }}" role="button" data-slide="prev">
                        <i class="fa fa-angle-left"></i>
                        </a>
                        <a class="carousel-control-next" href="{{ asset('landing/#banner_slider') }}" role="button" data-slide="next">
      ...
      <div class="about_section layout_padding" id="about-us">
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="about_img"><img src="{{ asset('landing/images/about-img.png') }}"></div>
               </div>
            </div>
         </div>
      </div>
                              ...
                              <div class="box_main">
                                 <div class="customer_main">
                                    ...
                                    <div class="customer_left">
                                       <div class="customer_img"><img src="{{ asset('landing/images/customer-img.png') }}"></div>
                                    </div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="footer_logo"><img src="{{ asset('landing/images/footer-logo.png') }}"></div>
               </div>
            </div>
            <div class="footer_section_2">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <div class="location_text"><img src="{{ asset('landing/images/call-icon.png') }}"><span class="padding_left_15"><a href="#">+01 1234567</a></span></div>
                     <div class="location_text"><img src="{{ asset('landing/images/mail-icon.png') }}"><span class="padding_left_15"><a href="#">demo@gmail.com</a></span></div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
